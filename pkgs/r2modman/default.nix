...
stdenv.mkDerivation (finalAttrs: {
  ...
  # very silly, but hey it fixes the parser error during the scripted updater
  patchPhase = ''
    runHook prePatch

    substituteInPlace yarn.lock \
      --replace-fail '# This file is generated by running "yarn install" inside your project. \
